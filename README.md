...
| Skill | 用途 |
| --- | --- |
| [`muyi-portrait-tang`](skills/muyi-portrait-tang/) | 将简短关键词扩写为新中式唐风成年女性双人闺蜜照中文提示词。 |

## 基本用法

安装后，可以显式调用 `$muyi-portrait-tang`，也可以直接提出与唐风双人古风人像、闺阁闺蜜照、花榻俯拍、对镜簪花、帘影逆光或雾感柔光提示词相关的请求。

这个 Skill 只生成提示词，不直接调用图像生成工具，不处理参考图编辑，也不生成视频提示词。人物固定为两位成年中国女性；涉及衣着、姿态和镜头语言时保持成年、非露骨和非窥视表达。
