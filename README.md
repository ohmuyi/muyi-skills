...
| Skill | 用途 |
| --- | --- |
| [`muyi-portrait-tang`](skills/muyi-portrait-tang/) | 将简短关键词或“随机一组”扩写为新中式唐风成年中国女性单人或双人人像中文提示词；普通输入未指定人数时默认单人，随机模式未指定时自由选择单人或双人。 |
...
只说“随机一组”或语义相同的随机请求时，Skill 会在一人和两人中自由选择，并生成一套连贯方案；“随机一组，单人”和“随机一组，双人”分别固定为对应人数。若同时指定场景、动作、色盘或构图，已指定条件会被保留，只随机补全其余内容。

这个 Skill 只生成提示词，不直接调用图像生成工具，不处理参考图编辑，也不生成视频提示词。它支持一位或两位成年中国女性，普通请求未指定人数时默认一位；“合照”与“闺蜜照”等语义按两位处理，零人、三人以上、多人或群像暂不支持。涉及衣着、姿态和镜头语言时保持成年、非露骨和非窥视表达。
